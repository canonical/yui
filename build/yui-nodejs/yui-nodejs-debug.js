    ...
    **/
        ...
        **/
                ...
                Y.Env = {
                    ...
                    parseBasePath: function (src, pattern) {
                        ...
                        if (match) {
                            path =
                                RegExp.leftContext ||
                                src.slice(0, src.indexOf(match[0]));
            ...
            if (doc && !doc.getElementById(CSS_STAMP_EL)) {
                ...
                doc &&
                doc.getElementById(CSS_STAMP_EL) &&
                !YUI.Env.cssStampEl
            ) {
    ...
    **/
        _setup: function () {
            var i,
                ...
                extras =
                    Y.config.core ||
                    [].concat(YUI.Env.core).concat(extendedCore); //Clone it..
...
**/
    ...
    **/
        _delayCallback: function (cb, until) {
            ...
            Y.log(
                "Delaying use callback until: " + until.event,
                "info",
                "yui"
            );
            return function () {
                ...
                Y._use(mod, function () {
                    Y.log(
                        "Delayed use wrapper callback after dependencies",
                        "info",
                        "yui"
                    );
                    Y.on(
                        ...
                        function () {
                            ...
                            Y.log(
                                "Delayed use callback done after " +
                                    until.event,
                                "info",
                                "yui"
                            );
        ...
        _notify: function (callback, response, args) {
            if (!response.success && this.config.loadErrorFn) {
                ...
                if (this.Env._missed && this.Env._missed.length) {
                    response.msg =
                        "Missing modules: " + this.Env._missed.join();
    ...
    **/
        _use: function (args, callback) {
            ...
            if ((mods.loader || mods["loader-base"]) && !Y.Loader) {
                Y.log(
                    "Loader was found in meta, but it is not attached. Attaching..",
                    "info",
                    "yui"
                );
            ...
            if (len) {
                ...
                len = missing.length;
                Y.log(
                    "Modules missing: " + missing + ", " + missing.length,
                    "info",
                    "yui"
                );
            }
            ...
            if (boot && len && Y.Loader) {
                ...
                if (G_ENV._bootstrapping) {
                    ...
                    Y.log(
                        "Fetching loader: " + config.base + config.loaderPath,
                        "info",
                        "yui"
                    );
                ...
                Y.log(
                    "Attaching available dependencies: " + args,
                    "info",
                    "yui"
                );
                ret = Y._attach(args);
...
**/
        Y.mix = function (
            ...
            if (mode) {
                ...
                from =
                    mode === 1 || mode === 3 ? supplier.prototype : supplier;
        ...
        YUI.Env.parseUA = function (subUA) {
            var numberify = function (s) {
                ...
                o = {
                     ...
                     */
                    winjs: !!(
                        typeof Windows !== "undefined" && Windows.System
                    ),
                    /**
...
**/
        Y.UA.compareVersions = function (a, b) {
            ...
            for (
                i = 0, len = Math.max(aParts.length, bParts.length);
                i < len;
                ++i
            ) {
            ...
            all: function (cat, args) {
                ...
                if (cat_o) {
                    Y.Object.each(cat_o, function (v, k) {
                        result.push(
                            k + ":" + (Y.Features.test(cat, k, args) ? 1 : 0)
                        );
                    });
                }
            ...
            test: function (Y) {
                ...
                addFeature("style", "opacity", {
                    test: function () {
                        return (
                            DOCUMENT &&
                            "opacity" in DOCUMENT[DOCUMENT_ELEMENT].style
                        );
                    }
                });
        ...
        add("load", "14", {
            ...
            test: function (Y) {
                var _JSON = Y.config.global.JSON,
                    Native =
                        Object.prototype.toString.call(_JSON) ===
                            "[object JSON]" && _JSON,
                    nativeSupport =
                        Y.config.useNativeJSONParse !== false && !!Native;
...
YUI.add(
    ...
    function (Y, NAME) {
        ...
        var logFn = function (str, t, m) {
            ...
            sys.error(
                this.consoleColor(t.toLowerCase() + ":", lvl) +
                    m +
                    " " +
                    this.consoleColor(str, mLvl)
            );
        };
        ...
        */
                    ...
                    if (rawMetaModules.hasOwnProperty(name)) {
                        ...
                        if (v && v.type === CSS) {
                            if (this.isCSSLoaded(v.name, true)) {
                                Y.log(
                                    "Found CSS module on page: " + v.name,
                                    "info",
                                    "loader"
                                );
                ...
                if (cache && !this.ignoreRegistered) {
                    ...
                    for (i in rawMetaModules) {
                        if (
                            ...
                            t = this._expandAliases(
                                rawMetaModules[i].condition.trigger
                            );
                            for (j = 0; j < t.length; j += 1) {
                                trigger = t[j];
                                this.conditions[trigger] =
                                    this.conditions[trigger] || {};
                                this.conditions[trigger][
                                    rawMetaModules[i].name || i
                                ] = rawMetaModules[i].condition;
                            }
                        }
                    }
            ...
            _resetModules: function () {
                ...
                for (i in self.moduleInfo) {
                    if (
                        self.moduleInfo.hasOwnProperty(i) &&
                        self.moduleInfo[i]
                    ) {
                        ...
                        if (details) {
                            ...
                            self.moduleInfo[name].requires =
                                details.requires || [];
                            self.moduleInfo[name].optional =
                                details.optional || [];
     ...
     */
            addModule: function (o, name) {
                ...
                if (!o.type) {
                    ...
                    if (p && this.REGEX_CSS.test(p)) {
                        Y.log(
                            "Auto determined module type as CSS",
                            "warn",
                            "loader"
                        );
                        o.type = CSS;
        ...
        */
                ...
                if (o.configFn) {
                    ...
                    if (ret === false) {
                        Y.log(
                            "Config function returned false for " +
                                name +
                                ", skipping.",
                            "info",
                            "loader"
    ...
    **/
            ...
            getRequires: function (mod) {
                ...
                for (i = 0; i < r.length; i++) {
                    ...
                    if (!hash[r[i]]) {
                        ...
                        if (m) {
                            ...
                            intl =
                                intl ||
                                (m.expanded_map && INTL in m.expanded_map);
                ...
                if (mod.skinnable) {
                    ...
                    if (
                        skindef &&
                        (skindef[name] || (skinpar && skindef[skinpar]))
                    ) {
                        skinname = name;
                        if (skindef[skinpar]) {
                            skinname = skinpar;
            ...
            isCSSLoaded: function (name, skip) {
                ...
                if (
                    ...
                    Y.log(
                        "isCSSLoaded was skipped for " + name,
                        "warn",
                        "loader"
                    );
                    return false;
            ...
            _visit: function (name, visited) {
                ...
                if (moduleInfo) {
                    ...
                    for (i = 0, l = dependencies.length; i < l; ++i) {
                        ...
                        isAfter =
                            trigger &&
                            (!trigger.when || trigger.when === "after");
                ...
                complete = function (d) {
                    ...
                    if (actions === comp) {
                        ...
                        if (self._refetch.length) {
                            ...
                            Y.log(
                                "Found potential modules to refetch",
                                "info",
                                "loader"
                            );
                            ...
                            if (mods.length) {
                                Y.log(
                                    "Refetching modules with new meta-data",
                                    "info",
                                    "loader"
                                );
                                self.require(mods);
            ...
            resolve: function (calc, sorted) {
                var self = this,
                    ...
                    addSingle,
                    usePathogen =
                        Y.config.comboLoader && Y.config.customComboBase;
                ...
                addSingle = function (mod) {
                    if (mod) {
                        var group =
                                (mod.group && self.groups[mod.group]) ||
                                NOT_FOUND,
                            url;
                ...
                if (hasComboModule) {
                    if (usePathogen) {
                        ...
                        resolved = this._encodeComboSources(
                            resolved,
                            comboSources
                        );
                    }
            ...
            _encodeComboSources: function (resolved, comboSources) {
                ...
                for (comboBase in comboSources) {
                    if (comboSources.hasOwnProperty(comboBase)) {
                        ...
                        Y.log(
                            "Using maxURLLength of " + maxURLLength,
                            "info",
                            "loader"
                        );
                            ...
                            if (type === JS || type === CSS) {
                                ...
                                if (maxURLLength <= comboBase.length) {
                                    Y.log(
                                        "maxURLLength (" +
                                            maxURLLength +
                                            ") is lower than the comboBase length (" +
                                            comboBase.length +
                                ...
                                if (frags.length) {
                                    if (baseLen > maxURLLength) {
                                        ...
                                        for (
                                            ...
                                            tmpBase =
                                                comboBase +
                                                fragSubset.join(comboSep);

                                            if (
                                                tmpBase.length > maxURLLength
                                            ) {
                                                frag = fragSubset.pop();
                                                tmpBase =
                                                    comboBase +
        ...
        Y.mix(YUI.Env[Y.version].modules, {
                        ...
                        addFeature("style", "opacity", {
                            test: function () {
                                return (
                                    DOCUMENT &&
                                    "opacity" in
                                        DOCUMENT[DOCUMENT_ELEMENT].style
                                );
                            }
                        });
            ...
            "history-hash-ie": {
                condition: {
                    ...
                    test: function (Y) {
                        var docMode =
                            Y.config.doc && Y.config.doc.documentMode;
                        ...
                        var _JSON = Y.config.global.JSON,
                            Native =
                                Object.prototype.toString.call(_JSON) ===
                                    "[object JSON]" && _JSON,
                            nativeSupport =
                                Y.config.useNativeJSONParse !== false &&
                                !!Native;
                        ...
                        var _JSON = Y.config.global.JSON,
                            Native =
                                Object.prototype.toString.call(_JSON) ===
                                    "[object JSON]" && _JSON,
                            nativeSupport =
                                Y.config.useNativeJSONStringify !== false &&
                                !!Native;
            ...
            "selector-css2": {
                condition: {
                    ...
                    test: function (Y) {
                        var DOCUMENT = Y.config.doc,
                            ret =
                                DOCUMENT && !("querySelectorAll" in DOCUMENT);
